...
function watch_room(room_name: string, wsServer: ws) {
...
function unwatch_room(room_name: string, wsServer: ws) {
  // Gets watcher list
  var watchlist = Watchlist[room_name] || []
...
wsServer.on("connection", function connection(wsServer: ws) {
